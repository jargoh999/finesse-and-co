              ...
              {navigation.map((item) => (
                <Link
                  ...
                  className={`text-base font-medium ${
                    pathname === item.href ? 'text-pink-600' : 'text-gray-700 hover:text-pink-500'
                  }`}
                >
                  {item.name}
                </Link>
            ...
            {navigation.map((item) => (
              <Link
                ...
                className={`block px-3 py-2 rounded-md text-base font-medium ${
                  pathname === item.href ? 'bg-pink-50 text-pink-600' : 'text-gray-700 hover:bg-gray-50 hover:text-pink-600'
                }`}
